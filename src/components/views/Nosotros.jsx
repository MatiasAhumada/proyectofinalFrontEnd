    ...
    <>
            ...
            <Row>
              ...
              <Col sm={12} md={4} lg={6}>
                ...
                >
                  ...
                  <p className="loremCompañero">
                    ...
                    investigar y como siempre me llamó la atención la
                    informática decidó probar; actualmente la programación es lo
              ...
              <Col sm={12} md={4} lg={6}>
                ...
                >
                  ...
                  />
                  <p className="loremCompañero">
                    ¡Hola! Soy Lucía, tengo 24 años, actualmente estoy
                    estudiando la carrera de programación en la Universidad
                    Tecnológica Nacional. Dos amigos me comentaron que iban a
                    estudiar en Rolling Code y no dudé en sumarme con ellos por
                    las buenas referencias que leí sobre éste curso y estoy muy
                    feliz de haber tomado esta decisión. Durante el cursado pude
              ...
              <Col sm={12} md={4} lg={6}>
                ...
                >
                  ...
                  />
                  <p className="loremCompañero">
                    Mi nombre es Fernando tengo 39 años y soy miembro de un
                    equipo de desarrollo de videojuegos llamado "Last Minute
                    Crew" como Game Designer y Level Designer usando motores
                    como Unreal Engine y Unity. Siempre me atrajo todo lo
                    relacionado a desarrollo y para poder seguir evolucionando
                    decidí emprender la nueva tarea de aprender programación,
                    desarrollo web y diseño de aplicaciones para que en un
                    futuro esto se convierta en mi principal fuente de ingresos.
      ...
      <MobileView>
        <div style={{ height: "10vh" }}>
          <h2 className="text-center my-3 titulo">Sobre Nosotros</h2>
          <h3 className="text-center my-2 titulo">Quienes Somos?</h3>
          <hr />
          <Container>
            <Row>
              <Col>
