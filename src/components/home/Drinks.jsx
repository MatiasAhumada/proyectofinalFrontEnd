...
const Drinks = () => {
    return (
        ...
        <hr />
        <p><span className='importante'>TEQUILA</span></p>
        <p>Hay tres tipos principales de tequila: blanco, reposado y añejo.  Si bien hay varios cocteles mexicanos con tequila, hacer una degustación te permitirá probar cada tipo, y verás que si bien son tragos populares en México, lo bueno es aún mejor si está ordenado.</p>
        <p><span className='importante'>MARGARITA</span></p>
