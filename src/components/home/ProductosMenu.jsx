      ...
      <Container>
        <Card className="dos" style={{ width: "20rem" }}>
          ...
          <Card.Body>
            ...
            <Card.Text>
              Tortilla de harina de trigo enrollada en forma cilíndrica rellena
              de diversos ingredientes y que se suele acompañar de frijoles
              refritos.
            </Card.Text>
          </Card.Body>
